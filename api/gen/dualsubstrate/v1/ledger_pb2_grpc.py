...
class DualSubstrateService(object):
    ...
    def Rotate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dualsubstrate.v1.DualSubstrateService/Rotate',
    ...
    def Append(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dualsubstrate.v1.DualSubstrateService/Append',
    ...
    def ScanPrefix(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dualsubstrate.v1.DualSubstrateService/ScanPrefix',
