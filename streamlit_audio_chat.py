...
def _live_console_html():
    ...
    .live-memory #badge {padding: 0.35rem 0.75rem; border-radius: 999px; background: #f1f3f5; font-weight: 600;}
...
if st.session_state.get("started"):
    components.html(_live_console_html(), height=640)
else:
    st.info("Press ▶️ Start streaming to open the socket and visualise audio.")
